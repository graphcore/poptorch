...
OP_DECL(popart, _ctcloss, _ctcloss, AiGraphcoreOpset1._ctcloss, ARG(INT,reduction) ARG(INT,blank) , BODY_ARG(static_cast<popart::ReductionType>(reduction)) BODY_ARG(blank) )
