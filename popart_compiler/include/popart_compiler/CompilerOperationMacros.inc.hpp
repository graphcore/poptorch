...
OP_DECL(popart, depthtospace, depthtospace, AiGraphcoreOpset1.depthtospace, ARG(INT,blocksize) ARG(STRING,mode) , BODY_ARG(blocksize) BODY_ARG(mode) )
...
OP_DECL(popart, remainder, remainder, AiGraphcoreOpset1.remainder, NONE, NONE)
OP_DECL(popart, reverse, reverse, AiGraphcoreOpset1.reverse, ARG(INT_VEC,dimensions) , BODY_ARG(dimensions) )
OP_DECL(popart, bitwisenot, bitwisenot, AiGraphcoreOpset1.bitwisenot, NONE, NONE)
OP_DECL(popart, bitwiseand, bitwiseand, AiGraphcoreOpset1.bitwiseand, NONE, NONE)
...
OP_DECL(popart, scatterreduce, scatterreduce, AiGraphcoreOpset1.scatterreduce, ARG(INT,axis_size) ARG(INT,axis) ARG(INT,reduction) , BODY_ARG(axis_size) BODY_ARG(axis) BODY_ARG(static_cast<popart::ScatterReduction>(reduction)) )
...
OP_DECL(popart, tfidfvectorizer, tfidfvectorizer, AiOnnxOpset10.tfidfvectorizer, ARG(INT,max_gram_length) ARG(INT,max_skip_count) ARG(INT,min_gram_length) ARG(STRING,mode) ARG(INT_VEC,ngram_counts) ARG(INT_VEC,ngram_indexes) ARG(INT_VEC,pool_int64s) ARG(STRING_VEC,pool_strings) ARG(FLOAT_VEC,weights) , BODY_ARG(max_gram_length) BODY_ARG(max_skip_count) BODY_ARG(min_gram_length) BODY_ARG(mode) BODY_ARG(ngram_counts) BODY_ARG(ngram_indexes) BODY_ARG(pool_int64s) BODY_ARG(pool_strings) BODY_ARG(weights) )
...
OP_DECL(popart, gru, gru, AiOnnxOpset10.gru, ARG(INT,num_outputs) ARG(FLOAT_VEC,activation_alpha) ARG(FLOAT_VEC,activation_beta) ARG(STRING_VEC,activations) ARG(FLOAT,clip) ARG(STRING,direction) ARG(INT,hidden_size) ARG(INT,linear_before_reset) , BODY_ARG(num_outputs) BODY_ARG(activation_alpha) BODY_ARG(activation_beta) BODY_ARG(activations) BODY_ARG(clip) BODY_ARG(direction) BODY_ARG(hidden_size) BODY_ARG(linear_before_reset) )
...
OP_DECL(popart, rnn, rnn, AiOnnxOpset10.rnn, ARG(INT,num_outputs) ARG(FLOAT_VEC,activation_alpha) ARG(FLOAT_VEC,activation_beta) ARG(STRING_VEC,activations) ARG(FLOAT,clip) ARG(STRING,direction) ARG(INT,hidden_size) , BODY_ARG(num_outputs) BODY_ARG(activation_alpha) BODY_ARG(activation_beta) BODY_ARG(activations) BODY_ARG(clip) BODY_ARG(direction) BODY_ARG(hidden_size) )
