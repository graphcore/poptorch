...
and `Graphcore's tutorials GitHub repository <https://github.com/graphcore/tutorials>`_ for `feature examples <https://github.com/graphcore/tutorials/tree/sdk-release-2.4/feature_examples/pytorch>`_,
`tutorials <https://github.com/graphcore/tutorials/tree/sdk-release-2.4/tutorials/pytorch>`_ and `simple applications <https://github.com/graphcore/tutorials/tree/sdk-release-2.4/simple_applications/pytorch>`_.
