...
and `Graphcore's tutorials GitHub repository <https://github.com/graphcore/tutorials>`_ for `feature examples <https://github.com/graphcore/tutorials/tree/sdk-release-2.3/feature_examples/pytorch>`_,
`tutorials <https://github.com/graphcore/tutorials/tree/sdk-release-2.3/tutorials/pytorch>`_ and `simple applications <https://github.com/graphcore/tutorials/tree/sdk-release-2.3/simple_applications/pytorch>`_.
