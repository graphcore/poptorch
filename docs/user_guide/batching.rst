...
relevant hyperparameters in PopTorch on Graphcore's tutorials repository: `PopTorch tutorial: Efficient data loading  <https://github.com/graphcore/tutorials/tree/sdk-release-2.4/tutorials/pytorch/tut2_efficient_data_loading>`_.
