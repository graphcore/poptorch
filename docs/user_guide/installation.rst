...
The following are the corresponding ``torch``, ``torchvision`` and
``torch_scatter`` versions and supported Python versions.

+--------------+-----------+-----------------+------------------------------+------------+
| ``poptorch`` | ``torch`` | ``torchvision`` |       ``torch_scatter``      | ``python`` |
+==============+===========+=================+==============================+============+
|     3.2      |   1.13.1  |      0.14.1     |   >=2.0.9 and <=2.1.0        |    >=3.7   |
+--------------+-----------+-----------------+------------------------------+------------+
|     3.1      |   1.13.0  |      0.14.0     |   >=2.0.9 and <=2.1.0        |    >=3.7   |
+--------------+-----------+-----------------+------------------------------+------------+
|     3.0      |   1.10.0  |      0.11.1     |             N/A              |    >=3.6   |
+--------------+-----------+-----------------+------------------------------+------------+
|     2.6      |   1.10.0  |      0.11.1     |             N/A              |    >=3.6   |
+--------------+-----------+-----------------+------------------------------+------------+
|     2.5      |   1.10.0  |      0.11.1     |             N/A              |    >=3.6   |
+--------------+-----------+-----------------+------------------------------+------------+
|     2.4      |   1.10.0  |      0.11.1     |             N/A              |    >=3.6   |
+--------------+-----------+-----------------+------------------------------+------------+
|     2.3      |   1.9.0   |      0.10.0     |             N/A              |    >=3.6   |
+--------------+-----------+-----------------+------------------------------+------------+
|     2.2      |   1.9.0   |      0.10.0     |             N/A              |    >=3.6   |
+--------------+-----------+-----------------+------------------------------+------------+
|     2.1      |   1.7.1   |      0.8.2      |             N/A              |    >=3.6   |
+--------------+-----------+-----------------+------------------------------+------------+
|     2.0      |   1.7.1   |      0.8.2      |             N/A              |    >=3.6   |
+--------------+-----------+-----------------+------------------------------+------------+
|     1.4      |   1.6.0   |      0.7.0      |             N/A              |    >=3.6   |
+--------------+-----------+-----------------+------------------------------+------------+
