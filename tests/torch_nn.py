...
EXPECTED_FAILURES = {
        ...
        "test_nn_Padding12_1dcircular": "RuntimeError: Double did not match Float",
        "test_nn_Padding31_1dcircular": "RuntimeError: Double did not match Float",
        "test_nn_Padding33_1dcircular": "RuntimeError: Double did not match Float",
        ...
        "test_nn_MultiheadAttention": "RuntimeError: Expected object of scalar type Float but got scalar type Double for argument #2 'other' in call to _th_equal",
        "test_nn_Transformer": "RuntimeError: Expected object of scalar type Double but got scalar type Float for argument #3 'mat2' in call to _th_addmm_out",
        "test_nn_BCELoss_weights_no_reduce": "RuntimeError: expected int at position 0, but got: Tensor",
        "test_nn_FractionalMaxPool2d_ratio": "RuntimeError: expected scalar type Float but found Double",
        "test_nn_FractionalMaxPool2d_size": "RuntimeError: expected scalar type Float but found Double",
        "test_nn_FractionalMaxPool3d_ratio": "RuntimeError: expected scalar type Float but found Double",
        "test_nn_FractionalMaxPool3d_size": "RuntimeError: expected scalar type Float but found Double",
        "test_nn_FractionalMaxPool3d_asymsize": "RuntimeError: expected scalar type Float but found Double",
...
def test_pytorch_nn(test_name):
    ...
    torch.testing.assert_allclose(ref, poptorch_out)
