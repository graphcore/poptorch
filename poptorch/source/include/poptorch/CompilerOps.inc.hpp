...
torch::jit::Node* createGroupedscatterreduce(torch::jit::Graph *graph,  const std::vector<torch::jit::Value *>& args,std::int32_t axis_size,std::int32_t axis,std::int32_t reduction,std::int32_t group_size);
